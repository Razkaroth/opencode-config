...
1. make sure that you are not in main.
2. compare the current branch with main.
3. using the commit messages on the branch, prepare a pr title and description.
4. use `gh pr create` to create a new pull-request targeting main.
5. report the output url back to user.
...
IMPORTANT: Never push changes and do not include files under `reference/` under any circumstance.
